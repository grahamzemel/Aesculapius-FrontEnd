<div class="bg-[#f8f8f8]">
	<div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
	  <div>
		<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">What is the Aesculapius bot?</h2>
		<p class="mt-4 text-gray-500">This bot, named after the Roman god of healing - Aesculapius - is designed to assist the healthcare system through multiple functions.</p>
