...
<section class="mt-[-12rem]">
	  ...
	  >
		<g transform="translate(960,380) scale(1,1) translate(-960,-440)">
		  <linearGradient
			...
			y2="0"
		  >
			<stop stop-color="hsl(221, 9%, 35%)" offset="0"></stop>
			<stop stop-color="hsl(221, 9%, 35%)" offset="1"></stop>
		  </linearGradient>
	  ...
	  <div class="container mx-auto">
		<div class="text-center text-gray-800">
		  <div class="block rounded-lg shadow-lg px-6 py-6 md:py-12 md:px-12" style="margin-top: 180px; background-color: hsla(0, 0%, 100%, 0.8);backdrop-filter: saturate(200%) blur(25px);">
			<h1 class="text-6xl md:text-7xl xl:text-8xl font-bold tracking-tight mb-12">Accuracy + <br>functionalty + <br> accessiblity = <br /><span class="text-gray-400">Aesculapius Healthcare</span></h1>
			<a class="inline-block px-7 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-gray-400 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#info">Get started</a>
			<a class="inline-block px-7 py-3 text-white font-medium text-sm leading-snug bg-transparent text-gray-400 font-medium text-xs leading-tight uppercase rounded hover:text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#info" role="button">Learn more</a>
		  </div>
		</div>
	  </div>  
	</section>
